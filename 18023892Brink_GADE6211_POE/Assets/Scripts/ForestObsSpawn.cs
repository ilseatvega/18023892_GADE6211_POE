...
public class ForestObsSpawn : MonoBehaviour
{
    ...
    void Start()
    {
        TreeBossStatus referenceTree = GameObject.FindGameObjectWithTag("Manager").GetComponent<TreeBossStatus>();
        //if status of boss is true (active)
        if (referenceTree.TreeStatus == true)
        {
            //dont do anything
            return;
        }
